...
import { ComplianceReport, ComplianceReportGlobal } from '../../../core/models/complianceReport';
...
@Component({
  ...
  imports: [TranslateModule, CommonModule, TableModule, RouterModule, ExportComponent],
})
